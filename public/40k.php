...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <p>Then put the ROS/ROSZ file here and wait for a little bit (a few seconds, tops, unless you're a dick and tried a 12,000 point Apoc list, in which case what the fuck):</p>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <div class="checkbox">
                    <input type="checkbox" name="big_data_sheet_appreciator" checked>GIMME THEM BIG SHEETS 
                </div>
            </div>
        </div>
        <div class="form-group">
